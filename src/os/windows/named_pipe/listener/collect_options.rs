...
impl PipeListenerOptions<'_> {
    // TODO(2.4.0) detailed error information like with streams
    ...
    pub fn collect_from_handle(handle: BorrowedHandle<'_>) -> io::Result<Self> {
        ...
        // TODO(2.4.0) error out if PIPE_SERVER_END in flags, check for REJECT_REMOTE_CLIENTS (its presence
        ...
        // TODO(2.4.0) security descriptor, inheritable
...
mod tests {
    ...
    fn check_collect<Rm: PipeModeTag, Sm: PipeModeTag>(original: PipeListenerOptions<'_>) {
        ...
        // FIXME(2.4.0) can't PartialEq security descriptors
    ...
    fn collect_duplex_byte() {
        let opts = PipeListenerOptions {
            ...
            security_descriptor: todo!(), // (2.4.0)
            inheritable: true,
            ..Default::default()
        };
