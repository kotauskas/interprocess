...
//!
//! ## Unix domain sockets
//! Those are sockets used specifically for local IPC. They support bidirectional connections, identification by file
//! path or inside the abstract Linux socket namespace, optional preservation of message boundaries (`SOCK_DGRAM`
//! UDP-like interface) and transferring file descriptor ownership.
//!
